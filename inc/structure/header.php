	...
	function storefront_child_site_branding() {
		$cur_lang = pll_current_language(); 
			...
			<div class="site-branding">
                            ...
                            <div href="" class="menu-langue"><a href="<?php echo $url_fr; ?>">Fr</a><a href="<?php echo $url_jp; ?>">Jp</a><a href="<?php echo $url_en; ?>" class="langCurrent">En</a></div>
			    ...
			    <!--<h1 class="site-title"><a href="<?php //echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php //bloginfo( 'name' ); ?></a></h1>-->
                            ...
                            <div class="site-logo">
                                ...
                                <svg viewBox="0 70 650 50" height="177" width="650px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" xml:space="preserve" style="display: block; width: 100%; height: 100%;">
