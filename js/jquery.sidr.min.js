...
(function(e) {
    var t = !1,
            ...
            execute: function(n, s, a) {
                ...
                if ("open" === n || "toggle" === n && !c.is(":visible")) {
                    ...
                    t = !0, "left" === h ? (r = {
                        ...
                        e(this).addClass(x)
                    }, g), c.css("display", "none").animate(d, g, function() {
        ...
        jQuery.fn.swipedetect = swipedetect;
        jQuery.fn.menu = n.execute;
    ...
    e.sidr = function(t) {
        ...
        if (0 === a.length && (a = e("<div />").attr("id", s).appendTo(e("body"))), a.addClass("sidr").addClass(i.side).data({
            ...
            if (e.each(l, function(t, i) {
                    if(e(i).html()) d += '<div class="sidr-inner">' + e(i).html() + "</div>";
                }), i.renaming) {
                var c = e("<div />").html(d);
