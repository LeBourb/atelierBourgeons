...
?>
    ...
    <div class="overlay-loader show" id="loader" style="position: fixed; top: 0px; right: 0px; bottom: 0px; left: 0px; width: 100%; background-color: rgb(255, 255, 255);">
        <svg viewBox="70 -100 100 400" enable-background="new 0 0 500 300" width="500px" version="1.1" id="Logo_Top" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="612px" xml:space="preserve" style="position: absolute; width: 50%; z-index: 2000; height: 50%; top: 25%; left: 25%;">
            <g>
