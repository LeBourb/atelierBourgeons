			...
			jetpack_the_site_logo();
				...
				<?php the_widget( 'WC_Widget_Cart', 'title=' ); ?>                                
                                ...
                                <ul href="" class="menu-langue">
                                    ...
                                    <form role="search" method="get" id="searchform" style="display:none;" action="<?php esc_url( home_url( '/'  ) )  ?>" >
                                        <div>
                                            <label class="screen-reader-text" for="s"><?php __( 'Search for:', 'woocommerce' )  ?></label>
                                            <input type="text" value="' . get_search_query() . '" name="s" id="s" placeholder="<?php __( 'My Search form', 'woocommerce' ) ?>" />
                                            <input type="submit" id="searchsubmit" value="<?php esc_attr__( 'Search', 'woocommerce' ) ?>" />
                            ...
                            <div class="snap-drawer snap-drawer-left" style="display:none;">
                                <form method="get" action="/search">
                                <input name="q" placeholder="Search" type="text">
                                <button type="submit">
                                    <img src="//cdn.shopify.com/s/files/1/0070/1922/t/12/assets/icon-mobile-nav-search.svg?6436615603036932485">
                                </button>
                                </form>
                                <ul>
                                    <li class="accordion-header first"><a href="/collections/all-mens">Mens <i></i></a></li>
                                    <li class="accordion-header"><a href="/collections/all-womens">Womens <i></i></a></li>
                                    <li class=" last"><a href="/workshop">Workshop</a></li>
                                </ul>
                            </div>
