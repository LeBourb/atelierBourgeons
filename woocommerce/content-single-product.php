        ...
        <div class="summary entry-summary">
            ...
            <ul class="share-product" >
                <li id="facebook" href="http://www.facebook.com/share.php?u=<?php echo get_permalink () ?>" onclick="window.open(this.href, 'FBwindow', 'width=650, height=450, menubar=no, toolbar=no, scrollbars=yes'); return false;" >
                     <img src="<?php echo get_site_url ( )?>/wp-content/themes/storefront-child/icons/facebook.png"  />
                </li>
                <li id="twitter"><img src="<?php echo get_site_url ( )?>/wp-content/themes/storefront-child/icons/twitter.png" /></li>
                <li id="instagram"><img src="<?php echo get_site_url ( )?>/wp-content/themes/storefront-child/icons/instagram.png" /></li>
            </ul>
		<?php
