jQuery( document ).ready( function($) {
	...
	$(this).on( 'change', '.custom_field, .custom_textarea, input.qty', function() {
        ...
        $("#giftcheckbox").change(function() {
            if(this.checked) {
                $("#gifttextarea").show();
                $("#gifttextarea").attr("required","");
                $("#gifttextarea").val($("#gifttextarea").attr("tempval"));
            }
            else {
                $("#gifttextarea").hide();
                $("#gifttextarea").removeAttr("required");
                $("#gifttextarea").attr("tempval", $('#gifttextarea').val());
                $("#gifttextarea").val('');
                $(this).trigger( 'show_options_final_total' );
            }
        });
	...
	$(this).on( 'show_options_final_total', function() {
		...
		$('.custom-options:visible').each( function() {
